...
public class CheckinController {
	...
	public List<CheckinDetails> getAllDetails()
	{
	 ...
	 //Delete Checkin Details Also Delete booking details And Payment
	 @DeleteMapping(value = "/cancel/{pnrNo}" )
	 @CrossOrigin ("http://localhost:4200")
	 @ApiOperation(value = "Inorder to cancel your CheckIn Details")
  ...
  //RestTemplate
		 RestTemplate restTemplate = new RestTemplate();
			...
			return checkinService.deleteByPnrNo(pnrNo);
			}
	 }
